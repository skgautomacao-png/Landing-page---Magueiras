...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Engenheiro de Transcodificação SK-G online. Informe o código SMC ou Festo para conversão imediata. 🛠️' }
  ]);
          ...
          >
            <div className="bg-gradient-to-r from-blue-900/50 to-slate-900/50 p-4 flex justify-between items-center border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-heading font-bold text-white text-xs tracking-wider uppercase">ATC - Suporte Técnico</h3>
              </div>
